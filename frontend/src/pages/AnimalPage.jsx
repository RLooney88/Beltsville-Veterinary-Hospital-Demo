...
const ANIMALS = {
  dogs: {
    ...
    life_stages: [
      ...
      { name: "Senior", age: "7 yrs +", focus: "Twice-yearly exams, bloodwork, joint support, PRP, quality-of-life planning.", icon: "heart", image: "/images/animals/dog-senior.webp" },
    ],
    conditions: [
    ...
    faqs: [
      ...
      { q: "What signs mean I should call you today?", a: "Not eating for 24 hours, repeated vomiting, difficulty breathing, suspected toxin ingestion, sudden lameness, seizures, or any bloated belly. Call (301) 937-3020." },
  ...
  critters: {
    slug: "critters",
    title: "Other Pet? Call First",
    noun: "pet",
    hero_headline: "Not sure whether we can help? Call us first.",
    hero_eyebrow: "Dogs & Cats Are Our Primary Focus",
    hero_copy:
      "Beltsville Veterinary Hospital primarily cares for dogs and cats. If you have a rabbit, small mammal, bird, reptile, or other pet, please call before scheduling so we can confirm whether we are a fit or guide you to the right specialist.",
    image: "/images/animals/hero-critters-page.webp",
    quote: {
      body: "The best thing we can do for any pet is be honest: what we can confidently treat, and when a species-specific specialist is the right next step. Please call first and we will point you in the right direction.",
      author: "Beltsville Veterinary Hospital team",
    },
    life_stages: [
      { name: "Call first", age: "Before scheduling", focus: "Tell us your pet's species, concern, and urgency so we can confirm the best next step.", icon: "paw", image: "/images/animals/rabbit-young.webp" },
      { name: "Confirm fit", age: "By phone", focus: "If the need is outside our scope, we will recommend a more appropriate exotics or emergency resource.", icon: "shield", image: "/images/animals/rabbit-adult.webp", objectPosition: "center top" },
      { name: "Dogs & cats", age: "Routine scheduling", focus: "For dogs and cats, book online or call for wellness, sick visits, dental care, surgery, diagnostics, and boarding questions.", icon: "heart", image: "/images/animals/rabbit-senior.webp" },
    ],
    conditions: [
      { name: "Species-specific needs", body: "Some pets need a veterinarian with dedicated exotics equipment and training. Call first so we can guide you honestly.", image: "/images/animals/rabbit-dental.webp" },
      { name: "Urgent appetite changes", body: "If a small mammal, rabbit, bird, or reptile stops eating or seems critically ill, call immediately or seek an exotics emergency clinic.", image: "/images/animals/rabbit-gi.webp" },
      { name: "Referral support", body: "If your pet is outside our day-to-day scope, we will help point you toward a better-fit resource rather than guessing.", image: "/images/animals/rabbit-skin.webp" },
      { name: "Dogs and cats", body: "Our regular care pages cover the dogs and cats we see every day for wellness, sick care, dental care, surgery, diagnostics, and boarding.", image: "/images/animals/gp-vitamin-c.webp" },
      { name: "Call before booking", body: "Please call (301) 937-3020 before using online booking for any pet other than a dog or cat.", image: "/images/animals/gp-skin.webp" },
    ],
    vaccines: {
    ...
    what_to_expect: [
      "A phone conversation first so we can confirm whether we are a good fit for your pet's species.",
      "Clear guidance if your pet should see an exotics-focused hospital or emergency clinic instead.",
      "No guessing or overpromising about species we do not routinely treat.",
      "Straightforward scheduling for dogs and cats through online booking or by phone.",
    ],
    faqs: [
      { q: "Do you see rabbits or small mammals?", a: "Please call first. Beltsville Veterinary Hospital primarily treats dogs and cats, and the team can confirm whether your pet's need is a fit or recommend a specialist." },
      { q: "What about reptiles, birds, or very exotic species?", a: "Call before scheduling. Some species are best served by an exotics-focused practice, and we would rather guide you correctly than overpromise." },
      { q: "My rabbit or small mammal stopped eating, is that urgent?", a: "Yes. Appetite changes in small mammals can be serious. Call immediately or seek an exotics emergency clinic if your pet seems unstable." },
      { q: "Can I use online booking for a non-dog or non-cat pet?", a: "Please call (301) 937-3020 first instead of booking online so the team can confirm fit and timing." },
      { q: "Which pets can I schedule normally?", a: "Dogs and cats can use the regular appointment flow for wellness, sick visits, dental care, surgery consults, diagnostics, and boarding inquiries." },
    ],
        ...
        <div className="relative z-10 h-full">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-36 lg:pt-40 pb-16">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              ...
              >
                <Phone className="h-4 w-4" /> Call (301) 937-3020
              </a>
              <Link
                to="/services"
